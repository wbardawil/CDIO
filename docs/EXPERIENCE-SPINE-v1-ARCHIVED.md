...
> This is **v1**, preserved for traceability. It specced only the Audit flow
> + the shell and was written 2026-05-13 after Customer #0 reported overwhelm.
> Customer #0 reported the **same** "shallow / walking it by the hand" signal
> again on 2026-05-19 — proof v1 was necessary but under-scoped. The canonical
> governing spec is now **`EXPERIENCE-SPINE.md` (v2)**, which keeps v1's five
> laws verbatim and adds the state primitive, two laws, the three throttles,
> the Deliverable Builder, and the full journey. Do not build against this file.
> ---
